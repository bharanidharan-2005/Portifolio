...
export default function HeroBlock({ data }) {
    return ( <
        ...
        <
        h1 className = "text-2xl md:text-3xl font-extrabold text-white tracking-tight leading-tight" > { data.heading || "Alex Chen — Software Developer" } <
        /h1> <
        p className = "text-xs text-slate-400 leading-relaxed max-w-md mx-auto" > { data.subheading || "Development AI-generated developer Portfolio presentation preview layer." } <
        /p> <
